<div class="<?php echo str_replace('_','-',$blockid); ?> <?php echo $blockcls;?>" id="pavo-<?php echo str_replace('_','-',$blockid); ?>">
  <div class="container">
    <div class="inside space-padding-tb-40">
      <div class="row">
        <?php if ($informations) { ?>
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 column xs-col-text-center">
          <div class="panel">
            <div class="panel-heading"><h3 class="panel-title xs-col-text-center">Chính sách</h3></div>
       ...
       <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 column xs-col-text-center">
            <div class="panel">
                <div class="panel-heading"><h3 class="panel-title xs-col-text-center">Danh mục</h3></div>
                <div class="panel-body">
                    <ul class="list-unstyled">
